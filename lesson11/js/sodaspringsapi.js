const apiURL = "//api.openweathermap.org/data/2.5/weather?id=5607916&appid=994a7d4fb87b563dad7d75913d018070&units=imperial"
fetch(apiURL)
  ...
  const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=994a7d4fb87b563dad7d75913d018070&units=imperial';
fetch(forecastURL)
  .then((response) => response.json())
  .then((forecastObject) => {
     ...
     for (let i = 0; i < towns.length; i++) {
         if (towns[i].name == "Soda Springs") {
            ...
            for (let x = 0; x < towns[i].events.length; x++) {
                ...
                document.getElementById("box").appendChild(eventBox);
            }
