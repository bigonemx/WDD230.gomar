const apiURL = "//api.openweathermap.org/data/2.5/weather?id=5585000&appid=994a7d4fb87b563dad7d75913d018070&units=imperial"
fetch(apiURL)
  ...
  const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5585000&units=imperial&appid=994a7d4fb87b563dad7d75913d018070&units=imperial';
fetch(forecastURL)
  .then((response) => response.json())
  .then((forecastObject) => {
